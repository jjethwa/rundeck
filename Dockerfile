...
RUN export DEBIAN_FRONTEND=noninteractive && \
    ...
    cd /tmp/ && \
    curl -Lo /tmp/rundeck.deb https://packagecloud.io/pagerduty/rundeck/packages/any/any/rundeck_3.4.10.20220118-1_all.deb/download.deb && \
    echo '8d515fc1c973f2d4c7ab50684f281946059a319d4e5445ddbbb8c197ea8a42be  rundeck.deb' > /tmp/rundeck.sig && \
