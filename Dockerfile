...
RUN export DEBIAN_FRONTEND=noninteractive && \
    ...
    cd /tmp/ && \
    curl -Lo /tmp/rundeck.deb https://packagecloud.io/pagerduty/rundeck/packages/any/any/rundeck_3.4.2.20210803-1_all.deb/download.deb && \
    echo '9828978b862d7e617dba29dd5da6485ae45d20692002c367d5d2e67783609e67  rundeck.deb' > /tmp/rundeck.sig && \
